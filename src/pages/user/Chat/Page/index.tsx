      ...
      <>
         ...
         <WrapperPage maxWidth="xl">
            <Grid container flexWrap="nowrap" height="100%">
               {/* Conversation */}
               <Grid item lg={4} p={1} sx={{ bgcolor: theme.palette.white.main, overflowY: "scroll" }}>
                  <Stack gap={2}>
               ...
               {/* Frame chat */}
               <Grid item lg={8} pt={1} boxShadow={2} bgcolor={theme.palette.white.main} width="100%" height="100%">
                  {conversation ? (
